...
module.exports = function(context){
  ...
  const docs = require('json-schema-docs')({ title: 'API Skeleton', schema: schemaHelpers.buildHeadersFromRoles(_.clone(schemas)) });
  app.get('/docs', function (req, res) {
      res.send(docs);
  });

  app.use(context.rootUri, schemaHelpers.buildRouterFromSchema(express.Router(), context.schemas, context.models));
