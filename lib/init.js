...
module.exports = function (info) {
    var context = this;
    context.helpers = _.assign(require('./helpers'), context.helpers);
    ...
    context.mode = process.env.HAYPI_ENV;
    ...
    context.events.init.call(context, app, function () {
        ...
        return Promise.props(_.transform(context.drivers, (result, val, key) => {
            ...
            for (let p of context.plugins) {
                ...
                _.assign(context.schemas, plugin.schemas());
