...
function cleanParamsAndCallModelFn (name, schema, params, user, fn, options, errors) {
    ...
    return {
        handler: (name, schema, fn) => {
            ...
            return function (req, res) {
                ...
                return cleanParamsAndCallModelFn(name, schema, params, user, fn, options, errors).then((result) => {
