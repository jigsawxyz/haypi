...
function cleanParamsAndCallModelFn (name, schema, params, user, fn, options) {
    ...
    .then(() => Promise.try(() => fn(params, user)))
    .then((data) => {
        dataToReturn = data;
...
module.exports = (name, schema, fn) => {
    ...
    return function (req, res) {
        ...
        return cleanParamsAndCallModelFn(name, schema, params, user, fn, options).then((result) => {
